...
import CadastreSeButton from "../../components/features/CadastreSe"
import TítuloField from "../../components/features/Título"
...
const Header = () => (
    <Fragment>
        <header className="xs:px-2 sm:py-2
                           sm:px-6 sm:py-3
                           md:px-8 sm:py-4
                           flex justify-start bg-brand-dark py-4 px-20 items-center ">
            <Logo />
            <TítuloField />
